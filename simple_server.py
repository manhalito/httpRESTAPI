...
#python simple_server.py 7000 127.0.0.1
#http -f POST http://127.0.0.1:7000/api/v1/addrecord/test Content-Type:application/json student1=Manhal student2=Farah student3=Yara Dr=Mohand
#http http://127.0.0.1:7000/api/v1/getrecord/test
